...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        this(unordered.size());  // improve, for optional extra education
...
//            int smallestIdx = champIndex(unordered);
//            list_iAS.add(unordered.get(smallestIdx));
//            unordered.set(smallestIdx, null);
//        }

        for (Integer val : unordered) {
            add(val);
        }
    }
     ...
     */
     private int champIndex( ArrayList<Integer> challengers) {
         Integer minVal = challengers.get(0);
         int minIndex = 0;
    ...
    public OrderedList_inArraySlots(int initialCapacity) {
        list_iAS = new java.util.ArrayList<Integer>(initialCapacity);
    }
